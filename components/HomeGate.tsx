      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 gap-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <h1 className="text-4xl font-bold tracking-tight">
            Willkommen beim DE Kalender
          </h1>
          <p className="text-muted-foreground text-lg max-w-md">
            Entdecke alle deutschen Feiertage für jedes Bundesland. Melde dich
            an oder erstelle ein Konto, um loszulegen.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Feiertage für alle 16 Bundesländer auf einen Blick.",
            },
            {
              title: "Immer aktuell",
              desc: "Bewegliche Feiertage wie Ostern werden automatisch berechnet.",
            },
            {
              title: "Dark Mode",
              desc: "Angenehme Ansicht bei Tag und Nacht.",
            },
          ].map((f) => (
